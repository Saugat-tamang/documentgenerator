...
document.addEventListener('click', (e)=>{
  if(!e.target.closest('#profileArea')) closeProfileMenu();
});
...
profileMenu.addEventListener('click', (e)=>{
  ...
  closeProfileMenu();
  if(action === 'logout'){
    showToast(dict[currentLang].toast_logout);
  }
  // 'profile' and 'settings' are template hooks — wire these to real routes/pages.
});
